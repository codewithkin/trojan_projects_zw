                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                                    {categories.map((cat) => (
                                        <div
                                            ...
                                            className={`p-3 rounded-lg border cursor-pointer transition-all text-center ${formData.category === cat.id
                                                    ? "border-2"
                                                    : "hover:bg-gray-50"
                                                }`}
                                            style={
                        ...
                        <CardContent className="space-y-2">
                            {priorities.map((priority) => (
                                <div
                                    ...
                                    className={`p-3 rounded-lg border cursor-pointer transition-all ${formData.priority === priority.id
                                            ? "border-2"
                                            : "hover:bg-gray-50"
                                        }`}
                                    style={
